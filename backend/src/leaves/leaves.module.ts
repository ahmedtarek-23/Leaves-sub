...
import { LeavesController } from './leaves.controller.clean';
...
@Module({
  imports: [
    // 1. Register Mongoose Schemas (Only the 8 original models remain)
    ...
    // 2. Import External Subsystem Dependencies
