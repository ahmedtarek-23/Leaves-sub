...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/leaves/manager/analytics", label: "Leave Analytics" },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/leaves/types", label: "Leave types" },
      { href: "/admin/leaves/entitlements", label: "Leave entitlements" },
      { href: "/admin/leaves/adjust-balance", label: "Adjust leave balance" },
      { href: "/admin/leaves/approvals", label: "Leave approvals (HR final)" },
      { href: "/admin/holidays", label: "Holiday calendar" },
    ],
