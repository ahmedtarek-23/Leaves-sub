    ...
    <div className="space-y-6">
      ...
      <div className="border border-gray-200 rounded-lg p-6 bg-white shadow-sm">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">
          Fiscal Year {summary.fiscalYear} Summary
        </h2>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-700 font-medium mb-1">Carried Forward</p>
            <p className="text-2xl font-bold text-blue-900">{summary.carriedForward} days</p>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            ...
            <p className="text-2xl font-bold text-red-900">{summary.expired} days</p>
            <p className="text-xs text-red-600 mt-1">Days that could not be carried forward</p>
          </div>
        </div>

        {/* Encashment Section */}
        {summary.encashmentAmount !== undefined && summary.encashmentDays !== undefined && (
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex justify-between items-center mb-2">
                ...
                <span className="text-sm font-medium text-green-900">
                  {summary.encashmentDays} days (capped at 30 days)
                </span>
              </div>
              {summary.dailySalaryRate && (
                <div className="flex justify-between items-center mb-2">
                  <span className="text-sm text-green-700">Daily Salary Rate:</span>
                  <span className="text-sm font-medium text-green-900">
                    ${summary.dailySalaryRate.toFixed(2)}
                  </span>
                </div>
              )}
              <div className="flex justify-between items-center pt-2 border-t border-green-200">
                ...
                <span className="text-lg font-bold text-green-900">
                  ${summary.encashmentAmount.toFixed(2)}
                </span>
              </div>
            </div>
